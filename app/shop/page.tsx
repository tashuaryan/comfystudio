      ...
      <div className="max-w-7xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-[#e2d5c5] p-8 md:p-12 max-w-4xl mx-auto">
            <button onClick={() => setActiveProduct(null)} className="flex items-center gap-2 text-[#8b4a62] font-semibold mb-8 hover:underline">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="flex flex-col justify-between">
                ...
                <button disabled={activeProduct.stock <= 0} className="w-full bg-[#633043] text-white py-4 rounded-xl font-semibold hover:bg-[#4a2432] transition-colors disabled:opacity-50 flex items-center justify-center gap-2 text-lg shadow-md">
                  <ShoppingBag size={22} /> {activeProduct.stock > 0 ? 'Add to Cart' : 'Sold Out'}
                </button>
              </div>
            </div>
          </div>
